...
var prefixStr=localStorage.getItem('prefix') || '';
...
var copyText = function(data){
	...
	if(dataSet.length==1 && getByteLength(dataSet[0])<=54){//title directed
		...
		dataSet[0]=prefixStr+dataSet[0].substr(2);
	}
...
var tranlateTrad = function(text){
...
var showNotification = function(msg,delay){
...
var saveImage = function(url,name,ext,id){
...
var onPrefixChange = function(data){
	prefixStr = data;
